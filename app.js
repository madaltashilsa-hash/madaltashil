...
+'</div>'
+'<div class="elig-learn reveal">'
+'<a href="eligibility-info.html" class="btn btn-gold">اضغط هنا لتعرف أكثر<span class="ar" aria-hidden="true">\u2039</span></a>'
+'<span class="elig-learn-note">خطوات التحقق · البيانات المطلوبة · شروط الأهلية</span>'
+'</div>'
+'<div class="elig-cta">'
